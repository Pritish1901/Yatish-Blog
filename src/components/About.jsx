        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className={`p-8 md:p-12 border-border shadow-sm hover:shadow-xl transition-all duration-500 transform ${
            ...
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6 transition-all duration-700 delay-200">
              ...
              <p className="text-muted-foreground leading-relaxed transition-all duration-700 delay-300">
